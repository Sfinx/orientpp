...
# -Wstrict-aliasing
# -O2
CFLAGS = -g3 -Wall -Wno-strict-aliasing -Wno-sequence-point -Winvalid-pch -std=gnu++0x -D_REENTRANT -D_GNU_SOURCE -D_THREAD_SAFE -I$(BOOST_INCLUDE_PATH) -I.
...
LDFLAGS := $(LDFLAGS) -lboost_system -lboost_date_time -lboost_program_options -lboost_thread -lpthread
